        ...
        while (contador <= empleados){
            ...
            switch (opcion){
                ...
                case 2:
                    ...
                    mec.calcularSueldoQna();
                    cadena = String.format("%s%s%20s%15s%15s%15.2f\n" ,cadena, mec.getRfc(), mec.getNombre(),
                            mec.dep, mec.getPuesto(), mec.getSueldoQuincenal());
                    break;
                case 3:
                    dep = "VENDEDOR";
                    salarioMin = 400;
